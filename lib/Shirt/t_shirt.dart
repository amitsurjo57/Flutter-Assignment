...
import 'package:ostad_flutter_assignment/Total%20Amount/total_amount.dart';
import 'package:ostad_flutter_assignment/Total%20Amount/total_amount_list.dart';
...
class _TShirtState extends State<TShirt> {
  int shirtPiece = 1;
  TotalAmountList totalAmountList = TotalAmountList();

  @override
  Widget build(BuildContext context) {
    return Consumer<TotalAmount>(
      builder: (context, amountModel, child) {
        totalAmountList.totalAmountList.add(amountModel);
        return Container(
